...
def test_annotations_import():
    from flake_core.annotations import (  # noqa: F401
        AnnotationsCache,
        FlakeMetadata,
        RLEFlake,
...
def test_image_processing_import():
    from flake_core.image_processing import (  # noqa: F401
...
def test_pipeline_import():
    from flake_core.pipeline import (  # noqa: F401
        run_background,
...
def test_no_qpress_imports():
    """No module under flake_core/ may import infrastructure.* / modules.* / utils.*"""
    src_root = Path(__file__).parent.parent / "src" / "flake_core"
